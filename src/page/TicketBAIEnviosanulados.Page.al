page 50034 "Ticket BAI Envios anulados"
{
    ApplicationArea = All;
        ...
        area(Content)
        {
            repeater(Group)
            {
                ...
                field(R_Descripcion_detallada; Rec.R_Descripcion_detallada)
                {
                    ...
                    ToolTip = 'Especifica R_Descripcion_detallada';
                }
    ...
    trigger OnOpenPage()
    begin
        Rec.SetRange(TipoRegistro, Rec.TipoRegistro::Anulación);
    end;
}