report 50095 "Sales - Invoice PRUEBA"
{
    ...
    requestpage
    {
        ...
        layout
        {
            area(Content)
            {
                group(Options)
                {
                    Caption = 'Options', Comment = 'ESP=""';
                    field(NoOfCopies; NoOfCopies)
                    {
                        Caption = 'No. of Copies', Comment = 'ESP=""';
                    }
                    field(ShowInternalInfo; ShowInternalInfo)
                    {
                        Caption = 'Show Internal Information', Comment = 'ESP=""';
                    }
                    field(LogInteraction; LogInteraction)
                    {
                        Caption = 'Log Interaction', Comment = 'ESP=""';
                        Enabled = LogInteractionEnable;
                    }
                    field(DisplayAsmInformation; DisplayAssemblyInformation)
                    {
                        Caption = 'Show Assembly Components', Comment = 'ESP=""';
                    }
                    field(DisplayAdditionalFeeNote; DisplayAdditionalFeeNote)
                    {
                        Caption = 'Show Additional Fee Note', Comment = 'ESP=""';
                    }
                }
            }
        }
    ...
    var
        ...
        Text000: Label 'Salesperson', Comment = 'ESP=""';
        Text001: Label 'Total %1', Comment = 'ESP=""';
        Text003: Label 'COPY', Comment = 'ESP=""';
        Text004: Label 'Sales - Invoice %1', Comment = 'ESP=""';
        PageCaptionCap: Label 'Page %1 of %2', Comment = 'ESP=""';
        ...
        Text007: Label 'VAT Amount Specification in ', Comment = 'ESP=""';
        Text008: Label 'Local Currency', Comment = 'ESP=""';
        VALExchRate: Text[50];
        Text009: Label 'Exchange rate: %1/%2', Comment = 'ESP=""';
        CalculatedExchRate: Decimal;
        Text010: Label 'Sales - Prepayment Invoice %1', Comment = 'ESP=""';
        OutputNo: Integer;
        ...
        Text1100000: Label 'Total %1 Incl. VAT+EC', Comment = 'ESP=""';
        Text1100001: Label 'Total %1 Excl. VAT+EC', Comment = 'ESP=""';
        ...
        BankAccNoCaptionLbl: Label 'Account No.', Comment = 'ESP=""';
        DueDateCaptionLbl: Label 'Due Date', Comment = 'ESP=""';
        InvoiceNoCaptionLbl: Label 'Invoice No.', Comment = 'ESP=""';
        PostingDateCaptionLbl: Label 'Posting Date', Comment = 'ESP=""';
        HdrDimsCaptionLbl: Label 'Header Dimensions', Comment = 'ESP=""';
        PmtinvfromdebtpaidtoFactCompCaptionLbl: Label 'The payment of this invoice, in order to be released from the debt, has to be paid to the Factoring Company.', Comment = 'ESP=""';
        UnitPriceCaptionLbl: Label 'Unit Price', Comment = 'ESP=""';
        DiscountCaptionLbl: Label 'Discount %', Comment = 'ESP=""';
        AmtCaptionLbl: Label 'Amount', Comment = 'ESP=""';
        VATClausesCap: Label 'VAT Clause', Comment = 'ESP=""';
        PostedShpDateCaptionLbl: Label 'Posted Shipment Date', Comment = 'ESP=""';
        InvDiscAmtCaptionLbl: Label 'Invoice Discount Amount', Comment = 'ESP=""';
        SubtotalCaptionLbl: Label 'Subtotal', Comment = 'ESP=""';
        PmtDiscGivenAmtCaptionLbl: Label 'Payment Disc Given Amount', Comment = 'ESP=""';
        PmtDiscVATCaptionLbl: Label 'Payment Discount on VAT', Comment = 'ESP=""';
        ShpCaptionLbl: Label 'Shipment', Comment = 'ESP=""';
        LineDimsCaptionLbl: Label 'Line Dimensions', Comment = 'ESP=""';
        VATAmtLineVATCaptionLbl: Label 'VAT %', Comment = 'ESP=""';
        ...
        VATIdentCaptionLbl: Label 'VAT Identifier', Comment = 'ESP=""';
        InvDiscBaseAmtCaptionLbl: Label 'Invoice Discount Base Amount', Comment = 'ESP=""';
        LineAmtCaption1Lbl: Label 'Line Amount', Comment = 'ESP=""';
        InvPmtDiscCaptionLbl: Label 'Invoice and Payment Discounts', Comment = 'ESP=""';
        ECAmtCaptionLbl: Label 'EC Amount', Comment = 'ESP=""';
        ECCaptionLbl: Label 'EC %', Comment = 'ESP=""';
        TotalCaptionLbl: Label 'Total';
        VALVATBaseLCYCaption1Lbl: Label 'VAT Base', Comment = 'ESP=""';
        VATAmtCaptionLbl: Label 'VAT Amount', Comment = 'ESP=""';
        VATIdentifierCaptionLbl: Label 'VAT Identifier', Comment = 'ESP=""';
        ShiptoAddressCaptionLbl: Label 'Ship-to Address', Comment = 'ESP=""';
        PmtTermsDescCaptionLbl: Label 'Payment Terms', Comment = 'ESP=""';
        ShpMethodDescCaptionLbl: Label 'Shipment Method', Comment = 'ESP=""';
        PmtMethodDescCaptionLbl: Label 'Payment Method', Comment = 'ESP=""';
        DocDateCaptionLbl: Label 'Document Date', Comment = 'ESP=""';
        HomePageCaptionCap: Label 'Home Page', Comment = 'ESP=""';
