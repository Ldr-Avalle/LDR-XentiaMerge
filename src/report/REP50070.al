report 50070 "Crear disco Modelo 347"
{
    ...
    dataset
    {
        ...
        dataitem(DataItem1000000001;Table18)
        {
            ...
            dataitem(DataItem1000000002;Table21)
            {
        ...
        dataitem(DataItem1000000004;Table23)
        {
            CalcFields = Inv. Amounts (LCY),Cr. Memo Amounts (LCY);
            DataItemTableView = SORTING(VAT Registration No.);
            dataitem(DataItem1000000005;Table25)
            {
