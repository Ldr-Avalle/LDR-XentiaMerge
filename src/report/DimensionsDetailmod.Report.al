report 50053 "Dimensions - Detail mod"
{
    ...
    var
        ...
        Text000: Label 'Please enter an analysis view code.', Comment = 'ESP="Por favor introduzca un cód. vista análisis."';
        Text001: Label 'Please enter a date filter.', Comment = 'ESP="Por favor introd. filt. fech."';
        Text002: Label 'Include Dimensions', Comment = 'ESP="Incluir dimensiones"';
        Text003: Label '(no dimension value)', Comment = 'ESP="(no valor dimensión)"';
        Text004: Label 'Not updated', Comment = 'ESP="No actualizar"';
        Text013: Label 'All amounts are in %1.', Comment = 'ESP="Todos imp. están en %1."';
        Text014: Label '(no business unit)', Comment = 'ESP="(no unidad negocio)"';
        Text015: Label 'All amounts are in ', Comment = 'ESP="Importes en "';
