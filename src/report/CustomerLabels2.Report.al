report 50012 "Customer - Labels2"
{
    DefaultLayout = RDLC;
    RDLCLayout = './src/layout/CustomerLabels.rdl';
    ApplicationArea = Suite;
    Caption = 'Customer - Labels', Comment = 'ESP="Cliente - Etiquetas"';
            ...
            area(content)
            {
                group(Options)
                {
                    ...
                    field(LabelFormat; LabelFormat)
                    {
                        ...
                        OptionCaption = '36 x 70 mm (3 columns),37 x 70 mm (3 columns),36 x 105 mm (2 columns),37 x 105 mm (2 columns)', Comment = 'ESP="36 x 70 mm (3 columnas),37 x 70 mm (3 columnas),36 x 105 mm (2 columnas),37 x 105 mm (2 columnas)"';
                        ToolTip = 'Specifies the format of the label.', Comment = 'ESP="Especifica el formato de la etiqueta"';
                    }
                }
            }
        }
