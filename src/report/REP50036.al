...
{
    DefaultLayout = RDLC;
    RDLCLayout = './Fixed Asset location.rdlc';

    dataset
    {
        dataitem(DataItem1000000000;Table5600)
        {
            ...
            dataitem(DataItem1000000001;Table5612)
            {
                ...
                column(FixedAsset_Location;"Fixed Asset".Location)
                {
                }
